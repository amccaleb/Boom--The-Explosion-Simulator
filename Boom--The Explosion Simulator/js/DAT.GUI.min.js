...
dat.controllers.Controller = function(e) {
	var a = function(a, d) {
		...
		this.object = a;
		this.property = d;
		this.__onFinishChange = this.__onChange =
		void 0
	};
	...
	a.extend(c.prototype, e.prototype, {
		setValue : function(a) {
			if (this.__min !==
				...
				a = this.__max;
			this.__step !==
			void 0 && a % this.__step != 0 && ( a = Math.round(a / this.__step) * this.__step);
...
dat.GUI = dat.gui.GUI = function(e, a, c, d, f, b, n, h, j, m, l, o, y, g, i) {
	...
	function t(a, b) {
		...
		if (d != -1) {
			...
			e ===
			void 0 && ( e = {}, c.__rememberedObjectIndecesToControllers[d] = e);
			e[b.property] = b;
	...
	function I(a) {
		...
		g.bind(c, "click", function() {
			h.innerHTML = JSON.stringify(a.getSaveObject(),
			void 0, 2);
			x.show();
			h.focus();
			h.select()
